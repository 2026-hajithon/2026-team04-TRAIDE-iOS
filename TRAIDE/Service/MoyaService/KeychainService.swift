...
class KeychainService {
    ...
    private let service = "TRAIDE.TRAIDE"
    ...
    // MARK: - Partial updates for tokens
    public func updateAccessToken(_ newAccessToken: String) {
        var info = self.loadTokenInfo() ?? TokenInfo(accessToken: "")
        info.accessToken = newAccessToken
        _ = self.saveTokenInfo(info)
